...
package com.hendrywinata.classin.utils
...
import com.hendrywinata.classin.AttendPresenceActivity
...
fun NotificationManager.sendGeofenceEnteredNotification(context: Context, foundIndex: Int) {
    val contentIntent = Intent(context, AttendPresenceActivity::class.java)
